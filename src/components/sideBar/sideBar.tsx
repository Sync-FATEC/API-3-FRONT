            ...
            <div className="sidebar sidebarDesktop">
                ...
                <div className="menu">
                    ...
                    <Link to="/dashboard" className="menu-item dashBoard">
                        <div style={{ textDecoration: 'none', color: '#8B909A', display: 'flex', alignItems: 'center', width: '100%' }}>
                    ...
                    <Link to="/projetosVencimentos" className="menu-item" id="gerenciarprojetos">
                        <div style={{ textDecoration: 'none', color: '#8B909A', display: 'flex', alignItems: 'center', width: '100%' }}>
                    ...
                    <Link to="/" className="menu-item logout" onClick={Logout}>
                        <div style={{ textDecoration: 'none', color: '#e74c3c', display: 'flex', alignItems: 'center', width: '100%' }} className='sair'>
